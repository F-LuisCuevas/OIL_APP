...
from shapely.geometry import Polygon
import shapely.wkt
import haversine #import haversine, Unit
import random
import time
...
if app_mode == 'Run App':
    ...
    col1.markdown('* [**Medium**](https://luiscuevas.netlify.app/)')
    col1.markdown('* [**LinkedIn**](https://www.linkedin.com/in/luis-enrique-cuevas-picos-b256a3186/)')
    col1.markdown('* [**Website**](https://luiscuevas.netlify.app/projects/)')
    col1.markdown('* [**GitHub**](https://github.com/F-LuisCuevas)')
